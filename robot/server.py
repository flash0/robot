...
from core.crypto1 import encrypt, decrypt, diffiehellman
from core import scan,persistence,survey,toolkit
...
goodbye             | Exit the server and kill all clients.
